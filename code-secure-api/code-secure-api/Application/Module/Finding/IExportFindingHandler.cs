...
public interface IExportFindingHandler : IHandler<FindingFilter, byte[]>;

public class ExportFindingHandler(AppDbContext context) : IExportFindingHandler
{
    public async Task<Result<byte[]>> HandleAsync(FindingFilter request)
    {
