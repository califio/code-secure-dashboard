...
)
{
    ...
    [
        new Claim(PermissionType.Project, PermissionAction.Read),
        new Claim(PermissionType.Project, PermissionAction.Update),
        new Claim(PermissionType.Project, PermissionAction.Delete),
        new Claim(PermissionType.User, PermissionAction.Create),
        new Claim(PermissionType.User, PermissionAction.Read),
        new Claim(PermissionType.User, PermissionAction.Update),
        new Claim(PermissionType.User, PermissionAction.Delete),
        new Claim(PermissionType.Role, PermissionAction.Create),
        new Claim(PermissionType.Role, PermissionAction.Read),
        new Claim(PermissionType.Role, PermissionAction.Update),
        new Claim(PermissionType.Role, PermissionAction.Delete),
        new Claim(PermissionType.Finding, PermissionAction.Read),
        new Claim(PermissionType.Finding, PermissionAction.Update),
        new Claim(PermissionType.Finding, PermissionAction.Delete),
        new Claim(PermissionType.CiToken, PermissionAction.Read),
    ...
    {
        await CreateUserAsync("system@defaul", "system", Application.Config.SystemPassword, true,
            RoleDefaults.Admin);
    }
