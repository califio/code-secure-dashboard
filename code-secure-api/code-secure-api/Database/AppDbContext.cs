    ...
    : IdentityDbContext<Users, Roles, Guid, UserClaims, UserRoles, UserLogins, RoleClaims, UserTokens>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Users>(b => { b.ToTable(nameof(Entity.Users)); });
        modelBuilder.Entity<Roles>(b => { b.ToTable(nameof(Entity.Roles)); });
        modelBuilder.Entity<RoleClaims>(b => { b.ToTable(nameof(Entity.RoleClaims)); });
        modelBuilder.Entity<UserClaims>(b => { b.ToTable(nameof(Entity.UserClaims)); });
        modelBuilder.Entity<UserLogins>(b => { b.ToTable(nameof(Entity.UserLogins)); });
        modelBuilder.Entity<UserRoles>(b => { b.ToTable(nameof(Entity.UserRoles)); });
        modelBuilder.Entity<UserTokens>(b => { b.ToTable(nameof(Entity.UserTokens)); });
    }
