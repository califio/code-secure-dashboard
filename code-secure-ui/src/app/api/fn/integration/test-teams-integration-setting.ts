...
export function testTeamsIntegrationSetting(http: HttpClient, rootUrl: string, params?: TestTeamsIntegrationSetting$Params, context?: HttpContext): Observable<StrictHttpResponse<boolean>> {
