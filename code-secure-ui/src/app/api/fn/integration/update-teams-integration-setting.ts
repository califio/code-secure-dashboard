...
export function updateTeamsIntegrationSetting(http: HttpClient, rootUrl: string, params?: UpdateTeamsIntegrationSetting$Params, context?: HttpContext): Observable<StrictHttpResponse<boolean>> {
